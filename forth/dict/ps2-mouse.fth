...
\ Default bounds (hex: 280=640d, 1E0=480d)
280 CONSTANT DEFAULT-XMAX
1E0 CONSTANT DEFAULT-YMAX
C CONSTANT MOUSE-IRQ
...
\ ---- Initialize mouse ----
: MOUSE-INIT ( -- )
    DEFAULT-XMAX MOUSE-XMAX !
    DEFAULT-YMAX MOUSE-YMAX !
